  ...
  return (
    <>
      ...
      <div className='grid grid-cols-12 items-center mx-auto w-full px-2'>
        ...
        <div className='col-span-12 md:col-span-6 w-full relative px-2 mt-5 border rounded-xl md:flex md:justify-center py-4'>
          ...
          <div>
            ...
            <div className='w-full flex  justify-center'>
              <div className="relative w-full md:w-[350px]    backdrop-blur-lg bg-[#000] bg-opacity-10 rounded-xl border border-white border-opacity-20">
